...
class OrderStuffSmallListAdapter(layoutResId: Int) :
    BaseQuickAdapter<TOrderDetail, BaseViewHolder>(layoutResId) {

    override fun convert(holder: BaseViewHolder, item: TOrderDetail) {
        item.apply {
